(function(e, t) {
    ...
    function l(e, n, r) {
        ...
        u = n + "mark",
        a = s.data(e, i, t, !0);
        a && (r === "queue" || !s.data(e, o, t, !0)) && (r === "mark" || !s.data(e, u, t, !0)) && setTimeout(function() { ! s.data(e, o, t, !0) && !s.data(e, u, t, !0) && (s.removeData(e, i, !0), a.resolve())
        },
        0)
    }
    function C() {
    ...
    function M(e) {
        ...
        e.namespace && (p = new RegExp("(^|\\.)" + e.namespace.split(".").join("\\.(?:.*\\.)?") + "(\\.|$)")),
        e.liveFired = this;
        var y = g.live.slice(0);
        for (a = 0; a < y.length; a++) o = y[a],
        o.origType.replace(w, "") === e.type ? m.push(o.selector) : y.splice(a--, 1);
        ...
        for (f = 0, l = i.length; f < l; f++) {
            ...
            for (a = 0; a < y.length; a++) {
                ...
                if (h.selector === o.selector && (!p || p.test(o.namespace)) && !h.elem.disabled) {
                    u = h.elem,
                    r = null;
                    if (o.preType === "mouseenter" || o.preType === "mouseleave") e.type = o.preType,
                    r = s(e.relatedTarget).closest(o.selector)[0],
                    r && s.contains(u, r) && (r = u); (!r || r !== u) && v.push({
                        elem: u,
                        handleObj: o,
                        level: h.level
                    })
    ...
    function R(e, t, n) {
        ...
        if (typeof t == "string") {
            ...
            if (B.test(t)) return s.filter(t, r, !n);
            t = s.filter(t, r)
        }
        return s.grep(e,
        function(e, r) {
    ...
    function et(e, t) {
        ...
        if (r = r[n]) {
            ...
            if (o) {
                delete i.handle,
                i.events = {};
                for (var u in o) for (var a = 0,
                f = o[u].length; a < f; a++) s.event.add(t, u + (o[u][a].namespace ? ".": "") + o[u][a].namespace, o[u][a], o[u][a].data)
            }
        }
    }
    function tt(e, t) {
    ...
    function gt(e, t, n) {
        ...
        i = t === "width" ? ht: pt;
        if (r > 0) return n !== "border" && s.each(i,
        function() {
            n || (r -= parseFloat(s.css(e, "padding" + this)) || 0),
            n === "margin" ? r += parseFloat(s.css(e, n + this)) || 0 : r -= parseFloat(s.css(e, "border" + this + "Width")) || 0
        }),
        r + "px";
        r = dt(e, t, t);
        ...
        n && s.each(i,
        function() {
            r += parseFloat(s.css(e, "padding" + this)) || 0,
            n !== "padding" && (r += parseFloat(s.css(e, "border" + this + "Width")) || 0),
            n === "margin" && (r += parseFloat(s.css(e, n + this)) || 0)
        }),
        r + "px"
    }
    function Ct() {
    ...
    function Lt(e, t) {
        var n = {};
        return s.each(Tt.concat.apply([], Tt.slice(0, t)),
        function() {
            n[this] = e
        }),
        n
    ...
    function At(e) {
        if (!yt[e]) {
            ...
            r.remove();
            if (i === "none" || i === "") {
                bt || (bt = n.createElement("iframe"), bt.frameBorder = bt.width = bt.height = 0),
                t.appendChild(bt);
                if (!wt || !bt.createElement) wt = (bt.contentWindow || bt.contentDocument).document,
                wt.write((n.compatMode === "CSS1Compat" ? "<!doctype html>": "") + "<html><body>"),
                wt.close();
                r = wt.createElement(e),
                wt.body.appendChild(r),
                i = s.css(r, "display"),
                t.removeChild(bt)
            }
            yt[e] = i
    ...
    s = function() {
        ...
        return r.fn = r.prototype = {
            ...
            init: function(e, i, s) {
                ...
                this.length = 1,
                this;
                if (e === "body" && !i && n.body) return this.context = n,
                this[0] = n.body,
                this.selector = e,
                this.length = 1,
                this;
                if (typeof e == "string") {
                    ...
                    if (o && (o[1] || !i)) {
                        if (o[1]) return i = i instanceof r ? i[0] : i,
                        l = i ? i.ownerDocument || i: n,
                        f = h.exec(e),
                        f ? r.isPlainObject(i) ? (e = [n.createElement(f[1])], r.fn.attr.call(e, i, !0)) : e = [l.createElement(f[1])] : (f = r.buildFragment([o[1]], [l]), e = (f.cacheable ? r.clone(f.fragment) : f.fragment).childNodes),
                        r.merge(this, e);
                        a = n.getElementById(o[2]);
                        if (a && a.parentNode) {
                            if (a.id !== o[2]) return s.find(e);
                            this.length = 1,
                            this[0] = a
                        }
            ...
            pushStack: function(e, t, n) {
                ...
                return r.isArray(e) ? T.apply(i, e) : r.merge(i, e),
                i.prevObject = this,
        ...
        r.extend = r.fn.extend = function() {
            ...
            for (; f < l; f++) if ((e = arguments[f]) != null) for (n in e) {
                ...
                s = e[n];
                if (a === s) continue;
                c && s && (r.isPlainObject(s) || (o = r.isArray(s))) ? (o ? (o = !1, u = i && r.isArray(i) ? i: []) : u = i && r.isPlainObject(i) ? i: {},
        ...
        r.extend({
            ...
            ready: function(e) {
                if (e === !0 && !--r.readyWait || e !== !0 && !r.isReady) {
                    ...
                    w.resolveWith(n, [r]),
                    r.fn.trigger && r(n).trigger("ready").unbind("ready")
                }
            },
            bindReady: function() {
                if (w) return;
                ...
                if (n.addEventListener) n.addEventListener("DOMContentLoaded", E, !1),
        ...
        _Deferred: function() {
            ...
            i = {
                    ...
                    if (!r) {
                        ...
                        o, u, a, f, l;
                        t && (l = t, t = 0);
                        for (o = 0, u = n.length; o < u; o++) a = n[o],
                        f = s.type(a),
                        f === "array" ? i.done.apply(i, a) : f === "function" && e.push(a);
    ...
    s.support = function() {
        ...
        l.checkClone = c.cloneNode(!0).cloneNode(!0).lastChild.checked,
        e.innerHTML = "",
        e.style.width = e.style.paddingLeft = "1px",
        h = n.getElementsByTagName("body")[0],
        d = n.createElement(h ? "div": "body"),
        v = {
            visibility: "hidden",
            width: 0,
            height: 0,
        ...
        l.boxModel = e.offsetWidth === 2,
        "zoom" in e.style && (e.style.display = "inline", e.style.zoom = 1, l.inlineBlockNeedsLayout = e.offsetWidth === 2, e.style.display = "", e.innerHTML = "<div style='width:4px;'></div>", l.shrinkWrapBlocks = e.offsetWidth !== 2),
        e.innerHTML = "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>",
        m = e.getElementsByTagName("td"),
        w = m[0].offsetHeight === 0,
        m[0].style.display = "",
        m[1].style.display = "none",
        l.reliableHiddenOffsets = w && m[0].offsetHeight === 0,
        e.innerHTML = "",
        n.defaultView && n.defaultView.getComputedStyle && (f = n.createElement("div"), f.style.width = "0", f.style.marginRight = "0", e.appendChild(f), l.reliableMarginRight = (parseInt((n.defaultView.getComputedStyle(f, null) || {
            marginRight: 0
        }).marginRight, 10) || 0) === 0),
        d.innerHTML = "",
        p.removeChild(d);
        ...
        w = y in e,
        w || (e.setAttribute(y, "return;"), w = typeof e[y] == "function"),
        l[b + "Bubbles"] = w;
        return d = c = o = u = h = f = e = a = null,
        l
    } (),
    ...
    s.extend({
        ...
        data: function(e, n, r, i) {
            ...
            h || (l ? e[s.expando] = h = ++s.uuid: h = s.expando),
            c[h] || (c[h] = {},
            l || (c[h].toJSON = s.noop));
            if (typeof n == "object" || typeof n == "function") i ? c[h][a] = s.extend(c[h][a], n) : c[h] = s.extend(c[h], n);
            return o = c[h],
            i && (o[a] || (o[a] = {}), o = o[a]),
            r !== t && (o[s.camelCase(n)] = r),
            n === "events" && !o[n] ? o[a] && o[a].events: (f ? (u = o[n], u == null && (u = o[s.camelCase(n)])) : u = o, u)
        },
        removeData: function(e, t, n) {
            ...
            var l = u[a][i];
            s.support.deleteExpando || !u.setInterval ? delete u[a] : u[a] = null,
            l ? (u[a] = {},
            o || (u[a].toJSON = s.noop), u[a][i] = l) : o && (s.support.deleteExpando ? delete e[s.expando] : e.removeAttribute ? e.removeAttribute(s.expando) : e[s.expando] = null)
        },
    ...
    s.fn.extend({
        data: function(e, n) {
            ...
            if (typeof e == "undefined") {
                if (this.length) {
                    ...
                    if (this[0].nodeType === 1) {
                        ...
                        o;
                        for (var u = 0,
                        f = i.length; u < f; u++) o = i[u].name,
                        o.indexOf("data-") === 0 && (o = s.camelCase(o.substring(5)), a(this[0], o, r[o]))
                    }
                }
                return r
            }
            ...
            var l = e.split(".");
            return l[1] = l[1] ? "." + l[1] : "",
            n === t ? (r = this.triggerHandler("getData" + l[1] + "!", [l[0]]), r === t && this.length && (r = s.data(this[0], e), r = a(this[0], e, r)), r === t && l[1] ? this.data(l[0]) : r) : this.each(function() {
                var t = s(this),
                r = [l[0], n];
    ...
    s.extend({
        ...
        queue: function(e, n, r) {
            if (e) {
                ...
                return r && (!i || s.isArray(r) ? i = s.data(e, n, s.makeArray(r), !0) : i.push(r)),
                i || []
            }
        },
    ...
    s.fn.extend({
        ...
        hasClass: function(e) {
            var t = " " + e + " ";
            for (var n = 0,
            r = this.length; n < r; n++) if (this[n].nodeType === 1 && (" " + this[n].className + " ").replace(c, " ").indexOf(t) > -1) return ! 0;
            return ! 1
        },
        val: function(e) {
            var n, r, i = this[0];
            if (!arguments.length) return i ? (n = s.valHooks[i.nodeName.toLowerCase()] || s.valHooks[i.type], n && "get" in n && (r = n.get(i, "value")) !== t ? r: (r = i.value, typeof r == "string" ? r.replace(p, "") : r == null ? "": r)) : t;
            var o = s.isFunction(e);
            return this.each(function(r) {
                var i = s(this),
                u;
                if (this.nodeType !== 1) return;
                o ? u = e.call(this, r, i.val()) : u = e,
    ...
    s.extend({
        ...
        attr: function(e, n, r, i) {
            var o = e.nodeType;
            if (!e || o === 3 || o === 8 || o === 2) return t;
            if (i && n in s.attrFn) return s(e)[n](r);
            if ("getAttribute" in e) {
                var u, a, f = o !== 1 || !s.isXMLDoc(e);
                return f && (n = s.attrFix[n] || n, a = s.attrHooks[n], a || (g.test(n) ? a = b: y && (a = y))),
                r !== t ? r === null ? (s.removeAttr(e, n), t) : a && "set" in a && f && (u = a.set(e, r, n)) !== t ? u: (e.setAttribute(n, "" + r), r) : a && "get" in a && f && (u = a.get(e, n)) !== null ? u: (u = e.getAttribute(n), u === null ? t: u)
            }
            return s.prop(e, n, r)
        },
        ...
        attrHooks: {
            type: {
                set: function(e, t) {
                    if (d.test(e.nodeName) && e.parentNode) s.error("type property can't be changed");
        ...
        prop: function(e, n, r) {
            ...
            return a && (n = s.propFix[n] || n, u = s.propHooks[n]),
            r !== t ? u && "set" in u && (o = u.set(e, r, n)) !== t ? o: e[n] = r: u && "get" in u && (o = u.get(e, n)) !== null ? o: e[n]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    s.event = {
        add: function(e, n, r, i) {
            ...
            while (c = n[h++]) {
                ...
                c.indexOf(".") > -1 ? (p = c.split("."), c = p.shift(), u.namespace = p.slice(0).sort().join(".")) : (p = [], u.namespace = ""),
                u.type = c,
                u.guid || (u.guid = r.guid);
                var d = f[c],
                v = s.event.special[c] || {};
                if (!d) {
                    d = f[c] = [];
                    if (!v.setup || v.setup.call(e, i, p, l) === !1) e.addEventListener ? e.addEventListener(c, l, !1) : e.attachEvent && e.attachEvent("on" + c, l)
                }
                v.add && (v.add.call(e, u), u.handler.guid || (u.handler.guid = r.guid)),
                d.push(u),
                s.event.global[c] = !0
            }
            e = null
        ...
        remove: function(e, n, r, i) {
            ...
            while (u = n[l++]) {
                ...
                c = u.indexOf(".") < 0,
                h = [],
                c || (h = u.split("."), u = h.shift(), p = new RegExp("(^|\\.)" + s.map(h.slice(0).sort(), N).join("\\.(?:.*\\.)?") + "(\\.|$)")),
                v = b[u];
                if (!v) continue;
                if (!r) {
                    for (f = 0; f < v.length; f++) {
                        m = v[f];
                        if (c || p.test(m.namespace)) s.event.remove(e, g, m.handler, f),
                        v.splice(f--, 1)
                    }
                    continue
                }
                ...
                for (f = i || 0; f < v.length; f++) {
                    m = v[f];
                    if (r.guid === m.guid) {
                        if (c || p.test(m.namespace)) i == null && v.splice(f--, 1),
            ...
            if (s.isEmptyObject(b)) {
                ...
                delete y.events,
                delete y.handle,
                s.isEmptyObject(y) && s.removeData(e, t, !0)
            }
        },
        customEvent: {
            getData: !0,
        ...
        trigger: function(n, r, i, o) {
            ...
            n.exclusive = f,
            n.namespace = a.join("."),
            n.namespace_re = new RegExp("(^|\\.)" + a.join("\\.(?:.*\\.)?") + "(\\.|$)");
            if (o || !i) n.preventDefault(),
            n.stopPropagation();
            if (!i) {
                s.each(s.cache,
                function() {
        ...
        fix: function(e) {
            ...
            if (e.pageX == null && e.clientX != null) {
                ...
                a = u.documentElement,
                f = u.body;
                e.pageX = e.clientX + (a && a.scrollLeft || f && f.scrollLeft || 0) - (a && a.clientLeft || f && f.clientLeft || 0),
                e.pageY = e.clientY + (a && a.scrollTop || f && f.scrollTop || 0) - (a && a.clientTop || f && f.clientTop || 0)
            }
        ...
        special: {
            ...
            live: {
                add: function(e) {
                    s.event.add(this, _(e.origType, e.selector), s.extend({},
                    e, {
                        handler: M,
                        guid: e.handler.guid
                    }))
    ...
    s.Event = function(e, t) {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault() ? k: C) : this.type = e,
        t && s.extend(this, t),
    ...
    var L = function(e) {
        ...
        r = e.type;
        e.type = e.data,
        t !== this && (t && (n = s.contains(this, t)), n || (s.event.handle.apply(this, arguments), e.type = r))
    },
    A = function(e) {
        e.type = e.data,
        s.event.handle.apply(this, arguments)
    };
    s.each({
    ...
    function(e, n) {
        s.fn[n] = function(e, r, i) {
            var o;
            if (typeof e == "object") {
                for (var u in e) this[n](u, r, e[u], i);
                return this
            }
            if (arguments.length === 2 || r === !1) i = r,
            r = t;
            n === "one" ? (o = function(e) {
                return s(this).unbind(e, o),
                i.apply(this, arguments)
            },
            o.guid = i.guid || s.guid++) : o = i;
            if (e === "unload" && n !== "one") this.one(e, r, i);
            else for (var a = 0,
            f = this.length; a < f; a++) s.event.add(this[a], e, o, r);
            return this
        }
    }),
    s.fn.extend({
        unbind: function(e, t) {
            ...
            i = this.length; r < i; r++) s.event.remove(this[r], e, t);
            return this
        },
        ...
        toggle: function(e) {
            ...
            i = function(n) {
                ...
                return s.data(this, "lastToggle" + e.guid, i + 1),
                n.preventDefault(),
    ...
    function(e, n) {
        s.fn[n] = function(e, r, i, o) {
            ...
            p = o ? this: s(this.context);
            if (typeof e == "object" && !e.preventDefault) {
                for (var d in e) p[n](d, r, e[d], h);
                return this
            }
            if (n === "die" && !e && o && o.charAt(0) === ".") return p.unbind(o),
            this;
            if (r === !1 || s.isFunction(r)) i = r || C,
            r = t;
            e = (e || "").split(" ");
            while ((u = e[a++]) != null) {
                f = w.exec(u),
                l = "",
                f && (l = f[0], u = u.replace(w, ""));
                if (u === "hover") {
                    e.push("mouseenter" + l, "mouseleave" + l);
                    continue
                }
                c = u,
                O[u] ? (e.push(O[u] + l), u += l) : u = (O[u] || u) + l;
                if (n === "live") for (var v = 0,
                m = p.length; v < m; v++) s.event.add(p[v], "live." + _(u, h), {
                    data: r,
                    selector: h,
                    handler: i,
                    origType: u,
                ...
                else p.unbind("live." + _(u, h), i)
            }
            return this
        }
    }),
    s.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),
    function(e, t) {
        s.fn[t] = function(e, n) {
    ...
    function() {
        ...
        var l = function(t, r, s, o) {
            ...
            if (x.length > 1 && h.exec(t)) if (x.length === 2 && c.relative[x[0]]) f = E(x[0] + x[1], r);
            else {
                f = c.relative[x[0]] ? [r] : l(x.shift(), r);
                while (x.length) t = x.shift(),
                c.relative[t] && (t += x.shift()),
                f = E(t, f)
            } else { ! o && x.length > 1 && r.nodeType === 9 && !S && c.match.ID.test(x[0]) && !c.match.ID.test(x[x.length - 1]) && (m = l.find(x.shift(), r, S), r = m.expr ? l.filter(m.expr, m.set)[0] : m.set[0]);
                if (r) {
                    m = o ? {
                        expr: x.pop(),
                        set: v(o)
                    }: l.find(x.pop(), x.length !== 1 || x[0] !== "~" && x[0] !== "+" || !r.parentNode ? r: r.parentNode, S),
                    f = m.expr ? l.filter(m.expr, m.set) : m.set,
                    x.length > 0 ? p = v(f) : w = !1;
                    while (x.length) g = x.pop(),
                    y = g,
                    c.relative[g] ? y = x.pop() : g = "",
                    y == null && (y = r),
                    c.relative[g](p, y, S)
                } else p = x = []
            }
            p || (p = f),
            p || l.error(g || t);
            if (i.call(p) === "[object Array]") if (!w) s.push.apply(s, p);
            else if (r && r.nodeType === 1) for (b = 0; p[b] != null; b++) p[b] && (p[b] === !0 || p[b].nodeType === 1 && l.contains(r, p[b])) && s.push(f[b]);
            else for (b = 0; p[b] != null; b++) p[b] && p[b].nodeType === 1 && s.push(f[b]);
            else v(p, s);
            return d && (l(d, u, s, o), l.uniqueSort(s)),
            s
        };
        ...
        var c = l.selectors = {
            ...
            relative: {
                ...
                "": function(e, t, n) {
                    var i, s = r++,
                    o = w;
                    typeof t == "string" && !f.test(t) && (t = t.toLowerCase(), i = t, o = b),
                    o("parentNode", t, s, e, i, n)
                },
                "~": function(e, t, n) {
                    var i, s = r++,
                    o = w;
                    typeof t == "string" && !f.test(t) && (t = t.toLowerCase(), i = t, o = b),
                    o("previousSibling", t, s, e, i, n)
                }
            },
            find: {
                ID: function(e, t, n) {
            ...
            preFilter: {
                ...
                ATTR: function(e, t, n, r, i, s) {
                    ...
                    return ! s && c.attrMap[o] && (e[1] = c.attrMap[o]),
        ...
        for (var d in c.match) c.match[d] = new RegExp(c.match[d].source + /(?![^\[]*\])(?![^\(]*\))/.source),
        c.leftMatch[d] = new RegExp(/(^(?:.|\r|\n)*?)/.source + c.match[d].source.replace(/\\(\d+)/g, p));
        var v = function(e, t) {
        ...
        l.getText = function(e) {
            ...
            n.nodeType === 3 || n.nodeType === 4 ? t += n.nodeValue: n.nodeType !== 8 && (t += l.getText(n.childNodes));
            return t
        },
        function() {
            var e = n.createElement("div"),
            ...
            n.getElementById(r) && (c.find.ID = function(e, n, r) {
        ...
        function() {
            ...
            e.getElementsByTagName("*").length > 0 && (c.find.TAG = function(e, t) {
            ...
            e.firstChild && typeof e.firstChild.getAttribute != "undefined" && e.firstChild.getAttribute("href") !== "#" && (c.attrHandle.href = function(e) {
            ...
            l = function(t, i, s, o) {
                ...
                if (!o && !l.isXML(i)) {
                    ...
                    if (u && (i.nodeType === 1 || i.nodeType === 9)) {
                        if (u[1]) return v(i.getElementsByTagName(t), s);
                        if (u[2] && c.find.CLASS && i.getElementsByClassName) return v(i.getElementsByClassName(u[2]), s)
                    }
                    if (i.nodeType === 9) {
                        if (t === "body" && i.body) return v([i.body], s);
                        if (u && u[3]) {
                            var a = i.getElementById(u[3]);
                            if (!a || !a.parentNode) return v([], s);
                            if (a.id === u[3]) return v([a], s)
                        }
                        try {
                        ...
                        m = i.parentNode,
                        g = /^\s*[+~]/.test(t);
                        p ? d = d.replace(/'/g, "\\$&") : i.setAttribute("id", d),
                        g && m && (i = i.parentNode);
                        try {
                            if (!g || m) return v(i.querySelectorAll("[id='" + d + "'] " + t), s)
                        } catch(y) {} finally {
        ...
        var E = function(e, t) {
            ...
            i = "",
            s = t.nodeType ? [t] : t;
            while (n = c.match.PSEUDO.exec(e)) i += n[0],
            e = e.replace(c.match.PSEUDO, "");
            e = c.relative[e] ? e + "*": e;
            for (var o = 0,
            u = s.length; o < u; o++) l(e, s[o], r);
            return l.filter(i, r)
        };
        s.find = l,
        s.expr = l.selectors,
        s.expr[":"] = s.expr.filters,
        s.unique = l.uniqueSort,
        s.text = l.getText,
        s.isXMLDoc = l.isXML,
    ...
    s.fn.extend({
        ...
        closest: function(e, t) {
            ...
            if (s.isArray(e)) {
                ...
                l = 1;
                if (o && e.length) {
                    for (r = 0, i = e.length; r < i; r++) a = e[r],
                    f[a] || (f[a] = F.test(a) ? s(a, t || this.context) : a);
                    while (o && o.ownerDocument && o !== t) {
                        for (a in f) u = f[a],
                        (u.jquery ? u.index(o) > -1 : s(o).is(u)) && n.push({
                            selector: a,
                            elem: o,
                            level: l
                        });
    ...
    function(e, t) {
        s.fn[e] = function(n, r) {
            ...
            i = this.length > 1 && !I[e] ? s.unique(i) : i,
            (this.length > 1 || H.test(r)) && P.test(e) && (i = i.reverse()),
    ...
    Y.th = Y.td,
    s.support.htmlSerialize || (Y._default = [1, "div<div>", "</div>"]),
    s.fn.extend({
        text: function(e) {
        ...
        after: function() {
            ...
            if (arguments.length) {
                ...
                return e.push.apply(e, s(arguments[0]).toArray()),
                e
            }
        },
        remove: function(e, t) {
        ...
        domManip: function(e, n, r) {
            var i, o, u, a, f = e[0],
            l = [];
            if (!s.support.checkClone && arguments.length === 3 && typeof f == "string" && K.test(f)) return this.each(function() {
            ...
            if (this[0]) {
                ...
                if (o) {
                    ...
                    for (var c = 0,
                    h = this.length,
                    p = h - 1; c < h; c++) r.call(n ? Z(this[c], o) : this[c], i.cacheable || h > 1 && c < p ? s.clone(u, !0, !0) : u)
                }
    ...
    s.buildFragment = function(e, t, r) {
        ...
        e.length === 1 && typeof e[0] == "string" && e[0].length < 512 && a === n && e[0].charAt(0) === "<" && !J.test(e[0]) && (s.support.checkClone || !K.test(e[0])) && (o = !0, u = s.fragments[e[0]], u && u !== 1 && (i = u)),
        i || (i = a.createDocumentFragment(), s.clean(e, a, i, r)),
        o && (s.fragments[e[0]] = u ? i: 1),
        {
            fragment: i,
            cacheable: o
        }
    ...
    s.extend({
        ...
        clean: function(e, t, r, i) {
            ...
            l; (l = e[f]) != null; f++) {
                typeof l == "number" && (l += "");
                if (!l) continue;
                if (typeof l == "string") if (!$.test(l)) l = t.createTextNode(l);
                else {
                    l = l.replace(W, "<$1></$2>");
                    var c = (X.exec(l) || ["", ""])[1].toLowerCase(),
                    h = Y[c] || Y._default,
                    p = h[0],
                    ...
                    } ! s.support.leadingWhitespace && z.test(l) && d.insertBefore(t.createTextNode(z.exec(l)[0]), d.firstChild),
                    l = d.childNodes
                }
                var g;
                if (!s.support.appendChecked) if (l[0] && typeof(g = l.length) == "number") for (a = 0; a < g; a++) it(l[a]);
                else it(l);
        ...
        cleanData: function(e) {
            ...
            i = s.expando,
            o = s.event.special,
            u = s.support.deleteExpando;
            for (var a = 0,
            f; (f = e[a]) != null; a++) {
                if (f.nodeName && s.noData[f.nodeName.toLowerCase()]) continue;
                n = f[s.expando];
                if (n) {
                    t = r[n] && r[n][i];
                    if (t && t.events) {
                        for (var l in t.events) o[l] ? s.event.remove(f, l) : s.removeEvent(f, l, t.handle);
                        t.handle && (t.handle.elem = null)
                    }
                    u ? delete f[s.expando] : f.removeAttribute && f.removeAttribute(s.expando),
                    delete r[n]
                }
            }
        }
    ...
    s.extend({
        ...
        style: function(e, n, r, i) {
            ...
            u = typeof r,
            u === "string" && (o = lt.exec(r)) && (r = +(o[1] + 1) * +o[2] + parseFloat(s.css(e, n)), u = "number");
    ...
    function(e, t) {
        s.cssHooks[t] = {
            get: function(e, n, r) {
                var i;
                if (n) return e.offsetWidth !== 0 ? gt(e, t, r) : (s.swap(e, ct,
                function() {
                    i = gt(e, t, r)
                }), i)
            },
    ...
    s.support.opacity || (s.cssHooks.opacity = {
        ...
        set: function(e, t) {
            var n = e.style,
            r = e.currentStyle,
            i = s.isNaN(t) ? "": "alpha(opacity=" + t * 100 + ")",
    ...
    n.defaultView && n.defaultView.getComputedStyle && (vt = function(e, n) {
        ...
        if (o = i.getComputedStyle(e, null)) r = o.getPropertyValue(n),
        r === "" && !s.contains(e.ownerDocument.documentElement, e) && (r = s.style(e, n));
        return r
    }),
    n.documentElement.currentStyle && (mt = function(e, t) {
        ...
        s = e.style;
        return ! at.test(r) && ft.test(r) && (n = s.left, i && (e.runtimeStyle.left = e.currentStyle.left), s.left = t === "fontSize" ? "1em": r || 0, r = s.pixelLeft + "px", s.left = n, i && (e.runtimeStyle.left = i)),
        r === "" ? "auto": r
    }),
    dt = vt || mt,
    ...
    var yt = {},
    bt, wt, Et = /^(?:toggle|show|hide)$/,
    St = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
    xt, Tt = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]],
    Nt;
    s.fn.extend({
        show: function(e, t, n) {
            var r, i;
            if (e || e === 0) return this.animate(Lt("show", 3), e, t, n);
            for (var o = 0,
            u = this.length; o < u; o++) r = this[o],
            r.style && (i = r.style.display, !s._data(r, "olddisplay") && i === "none" && (i = r.style.display = ""), i === "" && s.css(r, "display") === "none" && s._data(r, "olddisplay", At(r.nodeName)));
            for (o = 0; o < u; o++) {
                r = this[o];
                if (r.style) {
                    i = r.style.display;
        ...
        hide: function(e, t, n) {
            if (e || e === 0) return this.animate(Lt("hide", 3), e, t, n);
            for (var r = 0,
            i = this.length; r < i; r++) if (this[r].style) {
                var o = s.css(this[r], "display");
                o !== "none" && !s._data(this[r], "olddisplay") && s._data(this[r], "olddisplay", o)
            }
            for (r = 0; r < i; r++) this[r].style && (this[r].style.display = "none");
            return this
        },
        _toggle: s.fn.toggle,
        toggle: function(e, t, n) {
            ...
            return s.isFunction(e) && s.isFunction(t) ? this._toggle.apply(this, arguments) : e == null || r ? this.each(function() {
                ...
                s(this)[t ? "show": "hide"]()
            }) : this.animate(Lt("toggle", 3), e, t, n),
            this
        },
        ...
        animate: function(e, t, n, r) {
            ...
            e), this[i.queue === !1 ? "each": "queue"](function() {
                ...
                for (a in e) {
                    ...
                    n && (o === "height" || o === "width") && (t.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], s.css(this, "display") === "inline" && s.css(this, "float") === "none" && (s.support.inlineBlockNeedsLayout ? (f = At(this.nodeName), f === "inline" ? this.style.display = "inline-block": (this.style.display = "inline", this.style.zoom = 1)) : this.style.display = "inline-block"))
                }
                t.overflow != null && (this.style.overflow = "hidden");
                for (a in e) l = new s.fx(this, t, a),
                u = e[a],
                Et.test(u) ? l[u === "toggle" ? r ? "show": "hide": u]() : (c = St.exec(u), h = l.cur(), c ? (p = parseFloat(c[2]), d = c[3] || (s.cssNumber[a] ? "": "px"), d !== "px" && (s.style(this, a, (p || 1) + d), h = (p || 1) / l.cur() * h, s.style(this, a, h + d)), c[1] && (p = (c[1] === "-=" ? -1 : 1) * p + h), l.custom(h, p, d)) : l.custom(h, u, ""));
                return ! 0
            }))
        },
        stop: function(e, t) {
    ...
    s.extend({
        speed: function(e, t, n) {
            ...
            return r.duration = s.fx.off ? 0 : typeof r.duration == "number" ? r.duration: r.duration in s.fx.speeds ? s.fx.speeds[r.duration] : s.fx.speeds._default,
            r.old = r.complete,
            r.complete = function(e) {
                s.isFunction(r.old) && r.old.call(this),
                r.queue !== !1 ? s.dequeue(this) : e !== !1 && s._unmark(this)
            },
            r
        },
        easing: {
    ...
    s.fx.prototype = {
        ...
        custom: function(e, t, n) {
            ...
            o.elem = this.elem,
            o() && s.timers.push(o) && !xt && (xt = setInterval(i.tick, i.interval))
        },
        show: function() {
            this.options.orig[this.prop] = s.style(this.elem, this.prop),
            this.options.show = !0,
        ...
        step: function(e) {
            ...
            if (e || t >= i.duration + this.startTime) {
                ...
                for (o in i.animatedProperties) i.animatedProperties[o] !== !0 && (n = !1);
                if (n) {
                    i.overflow != null && !s.support.shrinkWrapBlocks && s.each(["", "X", "Y"],
                    function(e, t) {
                        r.style["overflow" + t] = i.overflow[e]
                    }),
                    i.hide && s(r).hide();
                    if (i.hide || i.show) for (var a in i.animatedProperties) s.style(r, a, i.orig[a]);
                    i.complete.call(r)
                }
                return ! 1
            }
            return i.duration == Infinity ? this.now = t: (u = t - this.startTime, this.state = u / i.duration, this.pos = s.easing[i.animatedProperties[this.prop]](this.state, u, 0, 1, i.duration), this.now = this.start + (this.end - this.start) * this.pos),
            this.update(),
            !0
        }
    },
    ...
    "getBoundingClientRect" in n.documentElement ? s.fn.offset = function(e) {
        ...
        while ((t = t.parentNode) && t !== a && t !== u) {
            if (s.offset.supportsFixedPosition && l.position === "fixed") break;
            n = f ? f.getComputedStyle(t, null) : t.currentStyle,
            c -= t.scrollTop,
            h -= t.scrollLeft,
            t === r && (c += t.offsetTop, h += t.offsetLeft, s.offset.doesNotAddBorder && (!s.offset.doesAddBorderForTableAndCells || !Ot.test(t.nodeName)) && (c += parseFloat(n.borderTopWidth) || 0, h += parseFloat(n.borderLeftWidth) || 0), i = r, r = t.offsetParent),
            s.offset.subtractsBorderForOverflowNotVisible && n.overflow !== "visible" && (c += parseFloat(n.borderTopWidth) || 0, h += parseFloat(n.borderLeftWidth) || 0),
            l = n
        }
    ...
    s.offset = {
        initialize: function() {
            ...
            o,
            u,
            a = parseFloat(s.css(e, "marginTop")) || 0,
            ...
            e.removeChild(t),
            s.offset.initialize = s.noop
        },
        bodyOffset: function(e) {
            var t = e.offsetTop,
            n = e.offsetLeft;
            return s.offset.initialize(),
            s.offset.doesNotIncludeMarginInBodyOffset && (t += parseFloat(s.css(e, "marginTop")) || 0, n += parseFloat(s.css(e, "marginLeft")) || 0),
            {
                top: t,
                left: n
            }
    ...
    s.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                ...
                while (e && !Mt.test(e.nodeName) && s.css(e, "position") === "static") e = e.offsetParent;
                return e
            })
        }
    }),
